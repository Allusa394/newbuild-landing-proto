...
- [ ] Скрипт: ширина >720px — горизонтальное, ≤720px — вертикальное; телефон боком получает горизонтальное; каждый качает только своё
- [ ] Тест: компьютер/планшет/телефон боком играют горизонтальное, телефон — вертикальное, отказы → картинка
