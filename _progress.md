...
- [ ] Вставка в hero: видео подгружается скриптом только на телефоне; reduced-motion / экономия трафика / отказ автоплея / ошибка загрузки → остаётся картинка
- [ ] Автотест видео + скриншоты старт/конец, телефон и компьютер
- [ ] Деплой, проверка на живой ссылке, показать Алле
- [ ] Горизонтальная версия для компьютера — ждём от Аллы (Flow: формат 16:9)
